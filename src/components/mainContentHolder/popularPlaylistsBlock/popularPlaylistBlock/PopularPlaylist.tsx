...
export const PopularPlaylistBlock:React.FC<PopularPlaylistProps> = (props)=>{
    ...
    return(
        <div>
            <Link href='/playlist'>
                <Image alt='Cover of playlist'src={PopularPlaylistData.CoverSrc} priority={true} placeholder="blur" width={256} style={{width:`13vw` , aspectRatio : 1/1, flexWrap: `wrap`}} className={`rounded-[9px] ${styles.PopularPlaylistCard}`}/>
            ...
            <div className="flex mt-[0px]">
                <button className={`p-0 m-0 ${styles.LikeButton}`} onClick={handleLikeClick}><Image alt='Like icon' style={likeIconStyle} src={Like}/></button>
