...
import CommentIcon from "~/public/popularReviews/comment.png";
import { useState } from "react";
import type { BestArticleProps } from "~/app/types/propsTypes.module";

export const BestArticle: React.FC<BestArticleProps> = ({ BestArticleData }) => {
    const [isLiked, setIsLiked] = useState<boolean>(false);
    const [likeCount, setLikeCount] = useState<number>(BestArticleData.LikeCount ?? 0);
        ...
        <div className="w-[330px] bg-[rgb(var(--gray))] rounded-t-lg overflow-hidden shadow-lg">
            ...
            <div className="p-4">
                <div className="flex items-center gap-2">
                    <Image
                        src={BestArticleData.authorCover}
                        alt="Author"
                        width={24}
                        height={24}
