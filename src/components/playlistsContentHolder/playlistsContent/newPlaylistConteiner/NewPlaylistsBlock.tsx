...
export const NewPlaylistsBlock : React.FC<PopularPlaylistsProps> = (props) => {
        ...
        useEffect(()=>{
            setDiscoveredAlbumsFirstPart(PopularPlaylistsData.slice(10,15))
            setDiscoveredAlbumsSecondPart(PopularPlaylistsData.slice(15,20))
        },[])
    return(
        <div className="ml-[30px] mr-[30px] mt-[45px] mb-[30px]">
            <div className="flex justify-between items-center">
                <p className={`text-[18pt]`}>Новые</p>
